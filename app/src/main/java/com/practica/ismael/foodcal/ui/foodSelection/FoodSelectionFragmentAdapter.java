...
public class FoodSelectionFragmentAdapter extends ListAdapter<Food, FoodSelectionFragmentAdapter.ViewHolder> implements Filterable {

    private List<Food> listFoods;
    private List<Food> listFoodsFiltered;
    private final MainActivityViewModel mainVM;

    FoodSelectionFragmentAdapter(MainActivityViewModel mainVM) {
    ...
    @NonNull
    @Override
    public FoodSelectionFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FoodSelectionFragmentAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).
                inflate(R.layout.fragment_list_selection_foods, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull FoodSelectionFragmentAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void saveFoodSelection() {
            mainVM.setFoodSelected(getItem(getAdapterPosition()));
        }
